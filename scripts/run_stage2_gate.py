#!/usr/bin/env python3
"""Collect deterministic Stage 2 gate evidence."""
...
GATE_DATABASE = "fictional_world_stage2_gate"
GATE_DATABASE_URL = (
    f"postgresql+psycopg://fictional_world:change-me-local@127.0.0.1:5432/{GATE_DATABASE}"
)
ALEMBIC_HEAD = "0004_stage2_continuity_tables"
SCENARIO_ID = "stage2-seven-day-world-v1"
    ...
    report.write_text(
        "\n".join(
            [
                ...
                "",
                f"- [{'x' if decision == 'PASS' else ' '}] seven full days / ten phases "
